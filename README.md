...
The "lockout" column makes it so that people with the same lockout number cannot be in the same group. An empty field indicates this constraint will not be applied. In the example, Eitenne will never be in Victoria's group regardless of their preferences.
